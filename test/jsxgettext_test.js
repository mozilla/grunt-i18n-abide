...
exports.jsxgettext = {
  ...
  testBasic: function(test) {
    test.expect(2);
    var created = 'test/tmp/basic.pot';
  ...
  testJinja: function(test) {
    var created = 'test/tmp/jinja.pot';
  ...
  testJinjaKeyword: function(test) {
    test.expect(2);
    var created = 'test/tmp/jinja-keyword.pot';
  ...
  testSorted: function(test) {
    test.expect(2);
    var created = 'test/tmp/sorted.pot';
